...
export function MyProfile() {
  ...
  const visibleNews = newsOpen ? latestNews : latestNews.slice(0, 1);
    ...
    <div className="page-shell profile-page">
      ...
      <Section eyebrow="News" title="The Latest News">
        <div className="news-panel">
          ...
          <button className="expand-button" onClick={() => setNewsOpen((value) => !value)}>
            {newsOpen ? 'Collapse news' : `Show all ${latestNews.length} news`}
            {newsOpen ? <ChevronUp size={18} /> : <ChevronDown size={18} />}
          </button>
        </div>
      </Section>

      <Section eyebrow="Biography" title="Biography">
        <div id="biography" className="profile-card">
          <div className="portrait-card">
            <div className="portrait-placeholder">ZM</div>
            <h3>Zeyuan Ma</h3>
            <p>Associate Professor</p>
            <p>School of Artificial Intelligence, SCNU</p>
          </div>
      ...
      <Section eyebrow="MetaEvo" title="My Research Team (MetaEvolution Lab, MetaEvo)">
        <div id="team" className="team-card">
          <div className="team-logo">MetaEvo</div>
          <div className="rich-text">
